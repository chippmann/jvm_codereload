...
internal fun debug(message: String) = printWithTextColor("Godot-JVM: DEBUG: $message", Color.GREEN)
internal fun info(message: String) = println("Godot-JVM: INFO: $message")
